...
<html lang="en">
  ...
  <body>
        <form action="inc/signup.php" method="POST" id="logform2">
            ...
            <div class="container col-md-5">
                ...
                <div class="form-group">
                    <label for="mail" class="control-label col-md-2"></label>
                    <div class="col-md-10">
                ...
                <div class="form-group">
                    <label for="passw2" class="control-label col-md-2"></label>
                    <div class="col-md-10">
                        <input class="form-control" placeholder="Confirm password" type="password" name="passw2" required>
                    </div>
                </div>
